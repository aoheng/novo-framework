...
import com.novo.framework.core.reflect.MethodUtil;
...
//        }
    ...
    private void getCellValue(Cell cell, Object o, Field field) throws IllegalAccessException, ParseException, Exception {
            ...
            case NUMERIC:
                if (DateUtil.isCellDateFormatted(cell)) {
                    ...
                    if (field.getType().getName().equals("int")) {
                        ...
                        field.set(o,value.intValue());
                        //InvokeMethod.invokeSetter(o,field,value.intValue());
