 ...
 * 动态事件（华迈云水机E1）
 */
public class D1_e_DynamicEventVO {
    ...
    /** 硬件事件位 */
    private D1_e_ByteArrayHardwareEvent hardwareEvent;
    /** 人机事件位 */
    private D1_ByteArrayHumanMachineEvent humanMachineEvent;
    /** 开关位 */
    ...
    public D1_e_ByteArrayHardwareEvent getHardwareEvent() { return hardwareEvent; }

    public void setHardwareEvent(D1_e_ByteArrayHardwareEvent hardwareEvent) { this.hardwareEvent = hardwareEvent; }

    public D1_ByteArrayHumanMachineEvent getHumanMachineEvent() { return humanMachineEvent; }

    public void setHumanMachineEvent(D1_ByteArrayHumanMachineEvent humanMachineEvent) { this.humanMachineEvent = humanMachineEvent; }
