 ...
 * 动态事件（碧丽三出水）
 */
public class D1_b_DynamicEventVO {
    ...
    /** 硬件事件位 */
    private D1_b_ByteArrayHardwareEvent hardwareEvent;
    /** 人机事件位 */
    ...
    public D1_b_ByteArrayHardwareEvent getHardwareEvent() { return hardwareEvent; }

    public void setHardwareEvent(D1_b_ByteArrayHardwareEvent hardwareEvent) { this.hardwareEvent = hardwareEvent; }
