 ...
 */
public enum D2_ByteWorkMode_T implements IEnum {
    NONE(0x00, "空挡", 0),
    ...
    D2_ByteWorkMode_T(int value, String comment, int washTotalTime) {
        this.value = value;
        this.comment = comment;
        this.washTotalTime = washTotalTime;
    }

    public static D2_ByteWorkMode_T parse(int value) {
        return IEnum.enumValueOf(D2_ByteWorkMode_T.class, value);
    }
