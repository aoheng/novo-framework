 ...
 * 动态事件（NOVO-BOT）
 */
public class D4_DynamicEventVO {
    ...
    /** 硬件事件位 */
    private D4_ByteArrayHardwareEvent hardwareEvent;
    /** 人机事件位 */
    private D4_ByteArrayHumanMachineEvent humanMachineEvent;
    /** 开关位 */
    ...
    public D4_ByteArrayHardwareEvent getHardwareEvent() {
        return hardwareEvent;
    }

    public void setHardwareEvent(D4_ByteArrayHardwareEvent hardwareEvent) {
        this.hardwareEvent = hardwareEvent;
    }

    public D4_ByteArrayHumanMachineEvent getHumanMachineEvent() {
        return humanMachineEvent;
    }

    public void setHumanMachineEvent(D4_ByteArrayHumanMachineEvent humanMachineEvent) {
