 ...
 * 实时信息（DN）
 */
public class D1_g_RealtimeVO extends DeviceVO {
    ...
    public DeviceServiceInfoVO getServiceInfo() {
        return serviceInfo;
    }

    public void setServiceInfo(DeviceServiceInfoVO serviceInfo) {
        this.serviceInfo = serviceInfo;
    }

    public Long getRemainServiceSeconds() {
        return remainServiceSeconds;
    }

    public void setRemainServiceSeconds(Long remainServiceSeconds) {
        this.remainServiceSeconds = remainServiceSeconds;
    }
    ...
    public String getPpfInfo() {
        return ppfInfo;
    }

    public void setPpfInfo(String ppfInfo) {
        this.ppfInfo = ppfInfo;
    }
