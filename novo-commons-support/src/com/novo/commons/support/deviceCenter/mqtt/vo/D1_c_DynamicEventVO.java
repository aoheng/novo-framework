 ...
 * 动态事件（1.5代机）
 */
public class D1_c_DynamicEventVO {
    ...
    /** 硬件事件位 */
    private D1_c_ByteArrayHardwareEvent hardwareEvent;
    /** 人机事件位 */
    ...
    public D1_c_ByteArrayHardwareEvent getHardwareEvent() { return hardwareEvent; }

    public void setHardwareEvent(D1_c_ByteArrayHardwareEvent hardwareEvent) { this.hardwareEvent = hardwareEvent; }
