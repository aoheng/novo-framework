 ...
 * 动态事件（浩泽二代机）
 */
public class D1_f_DynamicEventVO {
    ...
    /** 硬件事件位 */
    private D1_f_ByteArrayHardwareEvent hardwareEvent;
    /** 人机事件位 */
    ...
    public D1_f_ByteArrayHardwareEvent getHardwareEvent() {
        return hardwareEvent;
    }

    public void setHardwareEvent(D1_f_ByteArrayHardwareEvent hardwareEvent) {
        this.hardwareEvent = hardwareEvent;
    }

    public D1_ByteArrayHumanMachineEvent getHumanMachineEvent() {
        return humanMachineEvent;
    }

    public void setHumanMachineEvent(D1_ByteArrayHumanMachineEvent humanMachineEvent) {
