 ...
 * 动态事件（A6G）
 */
public class D1_d_DynamicEventVO {
    ...
    /** 硬件事件位 */
    private D1_d_ByteArrayHardwareEvent hardwareEvent;
    /** 人机事件位 */
    ...
    public D1_d_ByteArrayHardwareEvent getHardwareEvent() { return hardwareEvent; }

    public void setHardwareEvent(D1_d_ByteArrayHardwareEvent hardwareEvent) { this.hardwareEvent = hardwareEvent; }
