 ...
 * 动态事件（净水器）
 */
public class D1_DynamicEventVO {
    ...
    /** 硬件事件位 */
    private D1_ByteArrayHardwareEvent hardwareEvent;
    /** 人机事件位 */
    ...
    public D1_ByteArrayHardwareEvent getHardwareEvent() { return hardwareEvent; }

    public void setHardwareEvent(D1_ByteArrayHardwareEvent hardwareEvent) { this.hardwareEvent = hardwareEvent; }
