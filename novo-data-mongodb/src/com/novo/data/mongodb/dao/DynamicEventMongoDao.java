 ...
 */
@Component
public class DynamicEventMongoDao {
    ...
    public void insert(DynamicData dd) {
        ...
        mongoTemplate.insert(dd, MongoCollection.getCollection(dd.getProductCode(), dd.getImeiCode(), MongoCollection.DYNAMIC_EVENT));
    }

    public int count(DeviceMongoPagination page) {
        String collection = MongoCollection.getCollection(page.getProductCode(), page.getImeiCode(), MongoCollection.DYNAMIC_EVENT);
